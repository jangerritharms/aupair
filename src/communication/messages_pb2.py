...
_BLOCKINDEXENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='begin', full_name='BlockIndexEntry.begin', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='end', full_name='BlockIndexEntry.end', index=2,
